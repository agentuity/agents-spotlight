...
export const metadata = {
  ...
  description: 'A platform that provides AI agents with access to 100+ tools through MCP, enabling seamless integration with external services and code execution capabilities.',
  imageURL: '/showroom-exhibit-image/composio-agent.png',
  date: '2025-07-11',
  lastUpdatedDate: '2025-07-11',
  authorData: {
    showroomCardName: 'Agentuity Team',
    isCommunity: true,
    exhibitAuthorName: ' Matthew Congrove',
    exhibitAuthorLink: 'https://github.com/mcongrove',
  },
  links: {
    repository: 'https://github.com/agentuity/examples/tree/main/agents/composio',
    blog: 'https://composio.dev/blog',
    video: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
  },
  tags: ['Typescript', 'ai-sdk', 'Composio', 'MCP', 'AI Agents', 'Tool Integration', 'Code Execution', 'API Integration'],
  usecase: 'AI Agent Tooling',
};
