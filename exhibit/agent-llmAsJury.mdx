export const metadata = {
  ...
  imageURL: '/showroom-exhibit-image/agent-llmAsJury.png',
  date: '2025-01-16',
  ...
  tags: ['TypeScript', 'Multi-Agent System', 'Content Generation', 'Content Evaluation', 'Blog Posts', 'OpenAI', 'Claude', 'Mastra', 'GPT-4o'],
};
