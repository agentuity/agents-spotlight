export const metadata = {
  title: 'DMARC Email Report Processing Agent',
  ...
  imageURL: '/showroom-exhibit-image/agent-dmarc.png',
  date: '2025-01-16',
  ...
  tags: ['Python', 'Email Processing', 'DMARC', 'Security', 'Slack Integration', 'XML Parsing', 'OpenAI GPT-4o', 'Gmail API'],
};
