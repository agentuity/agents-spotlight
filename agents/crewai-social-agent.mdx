export const metadata = {
	title: 'Crew AI LinkedIn Content Generator',
	description: 'A multi-agent CrewAI system that generates LinkedIn-ready social media content from any topic. Uses researcher, writer, and editor agents to search the web, analyze insights, and create polished posts with markdown formatting and source references.',
	date: '2025-25-07',
	lastUpdatedDate: '2025-25-07',
	authorData: {
		spotlightCardName: 'Agentuity Team',
		isCommunity: false,
		featuredAuthorName: 'Dhilan Fye',
		featuredAuthorLink: 'https://github.com/agentuity/examples/commits?author=dhilanfye34',
	},
	links: {
		repository: 'https://github.com/agentuity/examples/tree/main/frameworks/crewai/socialagent',
	},
	tags: ['CrewAI', 'LinkedIn', 'Social Media', 'Content Generation', 'Web Search', 'Serper', 'Python', 'Multi-Agent'],
};
