export const metadata = {
  ...
  tags: ['Python', 'Trading', 'LangChain' , 'LangGraph', 'Financial Analysis', 'Portfolio Management', 'Technical Indicators', 'yfinance', 'CoinGecko', 'NewsAPI', 'FRED API', 'Agentuity SDK'],
};
