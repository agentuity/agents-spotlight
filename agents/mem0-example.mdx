...
export const metadata = {
	title: 'Mem0 Demo Agent - Best Buy Electronics Assistant',
	description: 'An intelligent Best Buy electronics assistant that demonstrates persistent memory capabilities using Mem0. Provides personalized product recommendations for laptops, TVs, and phones while remembering your preferences across conversations.',
	date: '2025-01-07',
	...
	links: {
		repository: 'https://github.com/agentuity/examples/tree/main/frameworks/miscellaneous/mem0/mem0demo',
		blog: 'https://agentuity.com/blog/how-to-cure-your-AI-agent-from-its-digital-Amnsia-mem0'
	},
	tags: ['Mem0', 'Memory', 'E-commerce', 'Product Recommendations', 'Python', 'OpenAI SDK'],
};
