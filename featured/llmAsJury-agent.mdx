export const metadata = {
  title: 'LLM as Jury System',
  description: 'A multi-agent system where one AI agent creates blog posts, and another AI agent evaluates them on multiple criteria using different AI models.',
  imageURL: 'https://cdn-icons-png.flaticon.com/512/1055/1055646.png',
  date: '2025-01-16',
  ...
  links: {
    repository: 'https://github.com/agentuity/agent-llmAsJury',
    blog: 'https://agentuity.com/blog/community-contributions-llm-judge',
  },
  tags: ['TypeScript', 'Multi-Agent System', 'Content Generation', 'Content Evaluation', 'Blog Posts', 'OpenAI', 'Claude', 'Mastra', 'GPT-4o', 'Agentuity SDK'],
};
