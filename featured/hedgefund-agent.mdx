export const metadata = {
  ...
  links: {
    ...
    blog: 'https://agentuity.com/blog/community-contributions-hedge-fund',
  },
  tags: ['Python', 'Trading', 'LangGraph', 'Financial Analysis', 'Portfolio Management', 'Technical Indicators', 'yfinance', 'CoinGecko', 'NewsAPI', 'FRED API', 'Agentuity SDK'],
};
