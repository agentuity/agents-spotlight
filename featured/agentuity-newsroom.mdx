export const metadata = {
  title: 'Newsroom: AI-Powered Content Pipeline',
  ...
  imageURL: '/spotlight-featured-image/agentuity-newsroom.png',
  date: '2025-01-16',
  ...
  tags: ['TypeScript', 'News Processing', 'Content Pipeline', 'Multi-Agent System', 'Podcast Generation', 'AI News', 'Firecrawl', 'OpenAI', 'Cloudflare R2', 'AI SDK', 'Agentuity SDK'],
};
